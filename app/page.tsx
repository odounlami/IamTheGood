...
import { LandingActions, LandingBottomCta } from "@/components/landing-actions"
      ...
      <main className="flex-1">
        <section className="mx-auto grid max-w-5xl gap-12 px-6 py-16 md:grid-cols-2 md:items-center md:py-24">
          <div className="flex flex-col gap-6">
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Pour les vendeurs Facebook &amp; WhatsApp Marketplace</span>
            <h1 className="text-balance font-serif text-4xl font-bold leading-[1.1] text-foreground md:text-5xl">La confiance qui se construit, avis après avis.</h1>
            <p className="text-pretty text-base leading-relaxed text-muted-foreground md:text-lg">Sur Marketplace, personne ne sait qui vous êtes avant le premier message. Créez un profil de réputation public, partagez votre lien dans vos annonces, et laissez vos acheteurs témoigner de votre sérieux avec un vrai cachet de confiance.</p>
